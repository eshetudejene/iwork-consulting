...
export function AnimatedBackground() {
  return (
    <div className="absolute inset-0 overflow-hidden -z-10">
      ...
      <motion.div
        className="absolute top-3/4 right-1/4 w-80 h-80 bg-gradient-brand opacity-10 rounded-full blur-3xl"
        animate={{
          x: [0, -80, 0],
          y: [0, 60, 0],
          scale: [1, 0.8, 1],
      ...
      <motion.div
        className="absolute top-1/2 left-1/2 w-8 h-1 bg-indigo-400/30"
        animate={{
          rotate: [0, 360],
          scale: [1, 1.2, 1],
        }}
